        ...
        <div id="content">
            <div class="row">
                <div class="row">
                    <div class="columns large-12 ctp-warning checks">
                        <p>Please be aware that this page will not be shown if you turn off debug mode unless you
                            disable the NotFoundException in src/Template/Pages/home.ctp.</p>
                    </div>
                </div>
                ...
                <div id="url-rewriting-warning" class="columns large-12 url-rewriting checks">
                    ...
                    <p>
                        1) <a target="_blank" href="http://book.cakephp.org/3.0/en/installation.html#url-rewriting">Help
                            me configure it</a>
                    </p>
                    <p>
                        2) <a target="_blank"
                ...
                <div class="columns large-5 platform checks">
                    ...
                    <?php else: ?>
                        <p class="problem">Your version of PHP is too low. You need PHP 5.5.9 or higher to use
                            CakePHP.</p>
                    <?php endif; ?>
                ...
                <div class="columns large-6 filesystem checks">
                    ...
                    <?php if (!empty($settings)): ?>
                        <p class="success">The <em><?= $settings['className'] ?>Engine</em> is being used for core
                            caching. To change the config edit config/app.php</p>
                    <?php else: ?>
            ...
            <div class="row">
                ...
                <div class="columns large-6">
                    ...
                    <ul>
                        ...
                        <li><a target="_blank"
                               href="http://book.cakephp.org/3.0/en/tutorials-and-examples/bookmarks/intro.html">The 15
                                min Bookmarker Tutorial</a></li>
                        <li><a target="_blank"
                               href="http://book.cakephp.org/3.0/en/tutorials-and-examples/blog/blog.html">The 15 min
                                Blog Tutorial</a></li>
                    </ul>
                    <p>
                </div>
            ...
            <div class="row">
                <div class="columns large-12">
                    ...
                    <p>
                        Our primary goal is to provide a structured framework that enables PHP users at all levels to
